...
public class Student implements Comparable<Student> {
	...
	// Car c=new FastFerrrari();
	// (FastFerrari)c.fastDriving
	// duplicate check
	public boolean equals(Object anotherObject) {
		...
		if( this.grade == anotherStuObject.grade   
			...
			return true;// Yes this and other stu object are equal/same/duplicate
		else
			return false;// No this and other stu object are different/unqiuq
